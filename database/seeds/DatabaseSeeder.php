...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \App\Models\Commander::create([
            ...
            'slug' => 'lt-strongarm',
            'name' => 'Lt. Strongarm',
            'flavor_description' => 'Lt. Strongarm leads the finest corps of engineers in the GDI armed forces. Tough as nails and smart as a whip, she delights in pulling pranks on the other members of the rank and file.',
            'rarity' => 'rare',
            'unlocked_at_level' => 1,
            'base_health' => 30000,
        ...
        \App\Models\Unit::create([
            ...
            'slug' => 'riflemen',
            'name' => 'Riflemen',
            'flavor_description' => 'The riflemen squad is GDI\'s standard infantry formation. Equipped with GD-2 automatic rifles and composite body armor, GDI Riflemen are an inexpensive and effective way of destroy enemy infantry units.',
            'item_description' => 'Provides vision up to 3 tiles away and reveals adjacent stealthed units.',
            'rarity' => 'common',
            'type' => 'infantry',
            'unlocked_at_level' => 1,
            'health' => 100,
